...
# Create a persistent folder for uploaded files (outside .streamlit to survive restarts)
...
if "user_id" not in st.session_state:
    st.session_state.user_id = str(uuid.uuid4())[:8]  # Unique ID for each user session
